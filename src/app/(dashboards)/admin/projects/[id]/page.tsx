...
// Mock data for project details - replace with actual API call later
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">{mockProjectDetails.name}</h1>
                <p className="mt-1 text-sm text-gray-600">{mockProjectDetails.description}</p>
              </div>
              <span className={`inline-flex rounded-full px-3 py-1 text-sm font-semibold ${
                mockProjectDetails.status === "مكتمل" 
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="mt-1 text-lg font-semibold">{mockProjectDetails.client}</div>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="text-sm font-medium text-gray-500">المدة</div>
                <div className="mt-1 text-lg font-semibold">
                  {mockProjectDetails.startDate} - {mockProjectDetails.endDate}
                </div>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="text-sm font-medium text-gray-500">الميزانية</div>
                <div className="mt-1 text-lg font-semibold">{mockProjectDetails.budget}</div>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="mt-2">
                  ...
                  <span className="mt-1 text-sm text-gray-600">{mockProjectDetails.progress}%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-xl bg-white p-6 shadow-sm">
              ...
              <div className="mt-2 flex items-baseline">
                <div className="text-3xl font-bold">{mockProjectDetails.totalHours}</div>
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm">
              ...
              <div className="mt-2 flex items-baseline">
                <div className="text-3xl font-bold">{mockProjectDetails.totalUsers}</div>
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm">
              ...
              <div className="mt-2 flex items-baseline">
                <div className="text-3xl font-bold">
                  {(mockProjectDetails.totalHours / 30).toFixed(1)}
                </div>
